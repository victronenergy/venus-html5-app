...
export const SERVICES = {
  ...
  VEBUS: objectValues(DBUS_PATHS.INVERTER_CHARGER.AC_LOADS)
    ...
    .concat(DBUS_PATHS.INVERTER_CHARGER.ACTIVE_INPUT)
    .concat(DBUS_PATHS.INVERTER_CHARGER.PRODUCT_ID)
    .concat(objectValues(DBUS_PATHS.INVERTER_CHARGER.ACTIVE_IN))
    .concat(objectValues(DBUS_PATHS.INVERTER_CHARGER.GENERATOR))
    .concat([DBUS_PATHS.INVERTER_CHARGER.SYSTEM.AC_NUMBER_OF_PHASES]),
  SETTINGS: objectValues(DBUS_PATHS.SETTINGS),
  SHORE_POWER: objectValues(DBUS_PATHS.INVERTER_CHARGER.SHORE_POWER)
}
...
export const TOPICS = {
  ...
  NOTIFICATION: {
    ALL: "N/#",
    SERIAL: `N/+/system/0${DBUS_PATHS.GENERAL.SERIAL}`,
    ALL_DEVICE_INSTANCES: `N/+/+/+${DBUS_PATHS.GENERAL.DEVICE_INSTANCE}`,
    SETTINGS_AC_INPUT_TYPE1: `N/+/settings/+${DBUS_PATHS.SETTINGS.AC_INPUT_TYPE1}`,
    SETTINGS_AC_INPUT_TYPE2: `N/+/settings/+${DBUS_PATHS.SETTINGS.AC_INPUT_TYPE2}`
  }
}
