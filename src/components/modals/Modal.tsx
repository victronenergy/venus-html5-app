  ...
  return (
    <div
      className={classNames(
        'fixed inset-0 z-10 p-8 text-neutral-600 bg-neutral-100 dark:text-white dark:bg-victron-darkGray/70 ',
    ...
    >
      <div className='absolute w-full max-w-sm mb-20 mr-6 bottom-0 right-0'>
        <div className='overflow-hidden p-4 dark:bg-victron-darkGray rounded-md shadow-[0_8px_24px_-15px_rgba(0,0,0,0.75)]'>
          {children}
        </div>
      </div>
    </div>
