...
const getAvailableDeviceBoxes = function (
  ...
  if (!!generatorFp.phases)
    devices.push(<GeneratorFp generatorFp={generatorFp} mode={mode} compactBoxSize={compactBoxSize} />)
  if (!!generatorRelay.settings) {
    if (generatorRelay.settings.includes(AC_SOURCE.GENERATOR)) {
      ...
      devices.push(<GeneratorRelay {...generatorRelay} mode={mode} compactBoxSize={compactBoxSize} />)
    }
  }
  return devices
}
